...
.directive('ngDatepicker', ['$document', function ($document) {
    ...
    return {
        ...
        link: function (scope, element, attrs, ngModel) {
            ...
            if (typeof scope.initial === 'undefined' || scope.initial === 'Invalid date' || scope.initial === '') {
                var date = moment();
            } else {
                var predate = new Date(scope.initial);
                var date = moment(predate);
            }
            ...
            if (typeof scope.initial !== 'undefined' && scope.initial !== 'Invalid date' && scope.initial !== '') {
                ngModel.$setViewValue(date.format(scope.format));
        ...
        template: '<div><input type="text" ng-focus="showCalendar()" ng-value="viewValue" class="ng-datepicker-input" placeholder="{{ placeholder }}" autocomplete="off"></div>' +
